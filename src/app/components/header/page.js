      ...
      <>
        <div className="header">
          ...
          <div className="header-menu">            
            ...
            <a className={pageName === "menu" ? "menu-link is-active" : "menu-link"} href="/menu"> <i className="fa-solid fa-book-open"></i> &nbsp; MENU </a>
            <a className={pageName === "rewards" ? "menu-link is-active" : "menu-link"} href="/rewards"> <i className="fa-solid fa-gift" style={{color:"#b7811f"}}> </i> &nbsp; REWARDS </a>
          </div>
