   ...
   <>
    ...
    <div className={`content-wrapper ${isOverlayVisible ? "overlay" : ""}`} >
      ...
      <section className="MainSection">
               <div className="circle" style={{ backgroundColor: selectedProduct.bgColor }}
               ></div>
      ...
      <div className="box-text">
        ...
        <a href="#" className="btn btn-light">Order Now</a>
      </div>
      </section>
      {/* Box C */}
    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <p>© 2023 Craft Coffee Company. All rights reserved.</p>
         ...
         <div
           className={`content-wrapper ${isOverlayVisible ? "overlay" : ""}`}
         >
           {/*cards*/}
           <div className="content-section">
